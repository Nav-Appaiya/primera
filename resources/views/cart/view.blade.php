            ...
            <table class="table table-hover">
                ...
                @foreach($items as $item)
                    <tr>
                        ...
                        <td class="col-sm-1 col-md-1 text-center"><strong>&euro;{{$item->product->price}}</strong></td>
                        <td class="col-sm-1 col-md-1">
                            <a href="/removeItem/{{$item->id}}"> <button type="button" class="btn btn-danger">
                                    <span class="fa fa-remove"></span> Verwijderen
                                </button>
                            </a>
                        </td>
                    </tr>
                ...
                <tr>
                    ...
                    <td>   </td>
                    <td><h3>Totaal</h3></td>
                    <td class="text-right"><h3><strong>&euro;{{$total}}</strong></h3></td>
                </tr>
                <tr>
                    <td>   </td>
                    <td>   </td>
                    ...
                    <td>
                        <button type="button" class="btn btn-success">
                            Bestelling afronden <span class="fa fa-play"></span>
                        </button></td>
                </tr>
                </tbody>
            </table>
