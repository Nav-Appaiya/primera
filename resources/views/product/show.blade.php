                ...
                <div class="artst-pic pull-left">
                    <a href="#">
                        @foreach($product->productimages as $image)
                            <img style="height: 200px; width: 200px; margin: 10px; border: 1px solid #777;" 
                                 src="/uploads/img/{{$image->imagePath}}"
                            >
                        @endforeach
                    ...
                    <div class="pull-right">
                        <div class="row center-block">
                            <div class="btn-group wishlist">
                                ...
                                {{-- Laravel form bindng om object aan form te 'binden'
                                    Laravel form binding zorgt ervoor dat we heel het
                                    product object kunnen meesturen. In de controller is deze
                                    te gebruiken via de geinjecteerde Request $request->get('product') 
                                    Nav Appaiya - 15-09-2016 20:54
                                --}}
                                {{ 
                                ...
                                {{-- Product opbject met eventuele properties --}}
